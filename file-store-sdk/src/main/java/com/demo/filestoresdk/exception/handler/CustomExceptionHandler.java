package com.demo.filestoresdk.exception.handler;


import static com.demo.filestoresdk.common.Constants.INVALID_SPECIAL_CHARACTERS_MESSAGE;

import com.demo.filestoresdk.exception.BadRequestException;
import com.demo.filestoresdk.exception.CustomException;
import com.demo.filestoresdk.exception.CustomRuntimeException;
import com.demo.filestoresdk.exception.DuplicateResourceException;
import com.demo.filestoresdk.exception.MultipleIllegalArgumentsException;
import com.demo.filestoresdk.exception.ResourceNotFoundException;
import com.demo.filestoresdk.exception.RestException;
import com.demo.filestoresdk.exception.UnAuthorizedException;
import com.demo.filestoresdk.model.error.ErrorDetails;
import com.demo.filestoresdk.model.error.InformationDisclosureHandlingConfig;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleCustomExceptions(final Exception ex, final Locale locale) {
        ...
        return new ResponseEntity<>(new ErrorDetails(errorMessage),
    ...
    public ResponseEntity<Object> handleFileUploadException(final Exception ex,
        final Locale locale) {
    ...
    private String getMessage(Locale locale, String message, Object[] o,
        ...
        try {
            if (enableInformationDisclosureHandling
                && informationDisclosureHandlingConfig.isEnabled()) {
    ...
    private String getErrorMessage(
        ...
        try {
            ...
            return StringUtils.isNotEmpty(errorMessage) ? messageSource.getMessage(errorMessage,
                null,
                locale) : EMPTY_STRING;
        } catch (NoSuchMessageException e) {
            return errorMessage;
